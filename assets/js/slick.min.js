!function(i) {
    ...
    (e = function() {
        ...
        return function(t, o) {
            ...
            (n = r.options.responsive || null) && n.length > -1) {
                for (l in r.respondTo = r.options.respondTo || "window",
                n)
                    n.hasOwnProperty(l) && (r.breakpoints.push(n[l].breakpoint),
            ...
            r.visibilityChange = "mozvisibilitychange") : void 0 !== document.msHidden ? (r.hidden = "msHidden",
            r.visibilityChange = "msvisibilitychange") : void 0 !== document.webkitHidden && (r.hidden = "webkitHidden",
    ...
    e.prototype.animateSlide = function(e, t) {
        ...
        e = Math.ceil(e),
        o[s.animType] = !1 === s.options.vertical ? "translate3d(" + e + "px, 0px, 0px)" : "translate3d(0px," + e + "px, 0px)",
        s.$slideTrack.css(o),
    ...
    e.prototype.autoPlayIterator = function() {
        ...
        i.slideHandler(i.currentSlide + i.options.slidesToScroll)) : (0 == i.currentSlide - 1 && (i.direction = 1),
    ...
    e.prototype.checkResponsive = function(e) {
        ...
        n.originalSettings.responsive && n.originalSettings.responsive.length > -1 && null !== n.originalSettings.responsive) {
            ...
            n.refresh())) : (n.activeBreakpoint = o,
            "unslick" === n.breakpointSettings[o] ? n.unslick() : (n.options = i.extend({}, n.originalSettings, n.breakpointSettings[o]),
            !0 === e && (n.currentSlide = n.options.initialSlide),
            n.refresh())) : null !== n.activeBreakpoint && (n.activeBreakpoint = null,
    ...
    e.prototype.changeSlide = function(e, t) {
        var o, s, n = this;
        switch (i(e.target).is("a") && e.preventDefault(),
        o = 0 != n.slideCount % n.options.slidesToScroll ? 0 : (n.slideCount - n.currentSlide) % n.options.slidesToScroll,
        e.data.message) {
        case "previous":
    ...
    e.prototype.destroy = function() {
        ...
        e.$slides.removeClass("slick-slide slick-active slick-center slick-visible").removeAttr("data-slick-index").css({
            position: "",
            left: "",
            top: "",
            zIndex: "",
    ...
    e.prototype.getLeft = function(i) {
        ...
        0 != s.slideCount % s.options.slidesToScroll && i + s.options.slidesToScroll > s.slideCount && s.slideCount > s.options.slidesToShow && (i > s.slideCount ? (s.slideOffset = -1 * (s.options.slidesToShow - (i - s.slideCount)) * s.slideWidth,
        n = -1 * (s.options.slidesToShow - (i - s.slideCount)) * t) : (s.slideOffset = -1 * s.slideCount % s.options.slidesToScroll * s.slideWidth,
        n = -1 * s.slideCount % s.options.slidesToScroll * t))) : i + s.options.slidesToShow > s.slideCount && (s.slideOffset = (i + s.options.slidesToShow - s.slideCount) * s.slideWidth,
        ...
        e = !1 === s.options.vertical ? -1 * i * s.slideWidth + s.slideOffset : -1 * i * t + n,
    ...
    e.prototype.getNavigableIndexes = function() {
        ...
        !0 === e.options.centerMode && (i = e.slideCount)) : (t = -1 * e.slideCount,
        o = -1 * e.slideCount,
    ...
    e.prototype.initDotEvents = function() {
        ...
        !0 === e.options.dots && !0 === e.options.pauseOnDotsHover && !0 === e.options.autoplay && i("li", e.$dots).on("mouseenter.slick", function() {
            e.paused = !0,
            e.autoPlayClear()
    ...
    e.prototype.initializeEvents = function() {
        ...
        !0 === e.options.autoplay && (i(document).on(e.visibilityChange, function() {
            e.visibility()
        }),
    ...
    e.prototype.setSlideClasses = function(i) {
        ...
        !0 === n.options.infinite && (i >= e && i <= n.slideCount - 1 - e ? n.$slides.slice(i - e, i + e + 1).addClass("slick-active") : (o = n.options.slidesToShow + i,
        t.slice(o - e + 1, o + e + 2).addClass("slick-active")),
        0 === i ? t.eq(t.length - 1 - n.options.slidesToShow).addClass("slick-center") : i === n.slideCount - 1 && t.eq(n.options.slidesToShow).addClass("slick-center")),
        n.$slides.eq(i).addClass("slick-center")) : i >= 0 && i <= n.slideCount - n.options.slidesToShow ? n.$slides.slice(i, i + n.options.slidesToShow).addClass("slick-active") : t.length <= n.options.slidesToShow ? t.addClass("slick-active") : (s = n.slideCount % n.options.slidesToShow,
        o = !0 === n.options.infinite ? n.options.slidesToShow + i : i,
        n.options.slidesToShow == n.options.slidesToScroll && n.slideCount - i < n.options.slidesToShow ? t.slice(o - (n.options.slidesToShow - s), o + s).addClass("slick-active") : t.slice(o, o + n.options.slidesToShow).addClass("slick-active")),
    ...
    e.prototype.selectHandler = function(e) {
        ...
        return o || (o = 0),
        t.slideCount <= t.options.slidesToShow ? (t.$slider.find(".slick-slide").removeClass("slick-active"),
        t.$slides.eq(o).addClass("slick-active"),
    ...
    e.prototype.slideHandler = function(i, e, t) {
        ...
        return e = e || !1,
        !0 === r.animating && !0 === r.options.waitForAnimate || !0 === r.options.fade && r.currentSlide === i || r.slideCount <= r.options.slidesToShow ? void 0 : (!1 === e && r.asNavFor(i),
        o = i,
        l = r.getLeft(o),
        n = r.getLeft(r.currentSlide),
        r.currentLeft = null === r.swipeLeft ? n : r.swipeLeft,
        !1 === r.options.infinite && !1 === r.options.centerMode && (0 > i || i > r.getDotCount() * r.options.slidesToScroll) ? void (!1 === r.options.fade && (o = r.currentSlide,
        !0 !== t ? r.animateSlide(n, function() {
            r.postSlide(o)
        }) : r.postSlide(o))) : !1 === r.options.infinite && !0 === r.options.centerMode && (0 > i || i > r.slideCount - r.options.slidesToScroll) ? void (!1 === r.options.fade && (o = r.currentSlide,
        !0 !== t ? r.animateSlide(n, function() {
            r.postSlide(o)
        }) : r.postSlide(o))) : (!0 === r.options.autoplay && clearInterval(r.autoPlayTimer),
        s = 0 > o ? 0 != r.slideCount % r.options.slidesToScroll ? r.slideCount - r.slideCount % r.options.slidesToScroll : r.slideCount + o : o >= r.slideCount ? 0 != r.slideCount % r.options.slidesToScroll ? 0 : o - r.slideCount : o,
        r.animating = !0,
        ...
        r.updateDots(),
        r.updateArrows(),
        !0 === r.options.fade ? (!0 !== t ? r.fadeSlide(s, function() {
            r.postSlide(s)
        }) : r.postSlide(s),
        void r.animateHeight()) : void (!0 !== t ? r.animateSlide(l, function() {
            r.postSlide(s)
        }) : r.postSlide(s))))
    }
    ,
    ...
    e.prototype.swipeMove = function(i) {
        ...
        !(!l.dragging || n && 1 !== n.length) && (e = l.getLeft(l.currentSlide),
        l.touchObject.curX = void 0 !== n ? n[0].pageX : i.clientX,
        l.touchObject.curY = void 0 !== n ? n[0].pageY : i.clientY,
        l.touchObject.swipeLength = Math.round(Math.sqrt(Math.pow(l.touchObject.curX - l.touchObject.startX, 2))),
        "vertical" !== (t = l.swipeDirection()) ? (void 0 !== i.originalEvent && l.touchObject.swipeLength > 4 && i.preventDefault(),
        s = (!1 === l.options.rtl ? 1 : -1) * (l.touchObject.curX > l.touchObject.startX ? 1 : -1),
        o = l.touchObject.swipeLength,
        l.touchObject.edgeHit = !1,
        !1 === l.options.infinite && (0 === l.currentSlide && "right" === t || l.currentSlide >= l.getDotCount() && "left" === t) && (o = l.touchObject.swipeLength * l.options.edgeFriction,
        l.touchObject.edgeHit = !0),
        l.swipeLeft = !1 === l.options.vertical ? e + o * s : e + o * (l.$list.height() / l.listWidth) * s,
    ...
    e.prototype.updateArrows = function() {
        ...
        !0 === i.options.arrows && !0 !== i.options.infinite && i.slideCount > i.options.slidesToShow && (i.$prevArrow.removeClass("slick-disabled"),
        i.$nextArrow.removeClass("slick-disabled"),
        0 === i.currentSlide ? (i.$prevArrow.addClass("slick-disabled"),
    ...
    e.prototype.visibility = function() {
        ...
        i.autoPlayClear()) : (i.paused = !1,
        i.autoPlay())
    }
    ,
    i.fn.slick = function() {
        for (var i, t = this, o = arguments[0], s = Array.prototype.slice.call(arguments, 1), n = t.length, l = 0; n > l; l++)
            if ("object" == typeof o || void 0 === o ? t[l].slick = new e(t[l],o) : i = t[l].slick[o].apply(t[l].slick, s),
            void 0 !== i)
                return i;
        return t
    }
